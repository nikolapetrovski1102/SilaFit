...
# (server-specific AllowedHosts from the migration), secrets/ and tde-cert-backup/
# are all server-side and are not in the repo.
...
rsync -az --delete \
  ...
  --exclude 'secrets' --exclude 'tde-cert-backup' \
